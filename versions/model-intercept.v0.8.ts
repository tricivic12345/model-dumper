...
interface LLMCallRecord {
  ...
  timingSource?: 'client_measured' | 'generations_api' | 'session_estimated' | null;
  timingNote?: string;
}
...
const plugin = {
  ...
  description: "Intercept and log LLM API calls with timing metrics",
  version: "1.1.0",
  configSchema: {
    type: "object",
    properties: {},
  ...
  register(api: OpenClawPluginApi) {
    console.log('[model-intercept] Registering model intercept plugin v1.1.0');
